...
class KeywordCoverage():
    ...
    def print_keywords(self, content):
...
if __name__ == "__main__":
    ...
    summaries = ["In selling elephant ivory is illegal."]
    ...
    for body, score, ns_score in zip(contents, scores, no_summ_acc):
        ...
        print(summaries[0])
        print("---------- keyword ----------")
        kw_cov.print_keywords(body)
        print("-----------------------------")
        print("-----------------------------")
        print("--- summary coverage score =  ---")
        print(score) # score == accs_w - accs_wo
        print("-- empty doc coverage score --")
        print(ns_score.item()) # ns_score == accs_wo
